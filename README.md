...
**This is the one fixture in the repo that cannot be produced without an account,**
so it is generated by hand and committed. Until it is, the six golden tests in
`backend/tests/test_njt_static.py` skip locally and **fail in CI** (see
